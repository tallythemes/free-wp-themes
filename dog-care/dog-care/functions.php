...
function tally_child_load_before_parant_theme(){
	...
	define('TALLY_THEME_STORE_URL', 'http://tallythemes.com/product/dog-care-wordpress-theme/');
	define('TK_THEME_NAME', 'Dog Care');
	define('TALLY_THEME_NAME', 'Dog Care');
	define('TALLY_THEME_DEMO_URL', esc_url('http://tallythemes.com/preview/dog-care-wordpress-theme-preview/'));
	define('TALLY_THEME_DOC_URL', esc_url('http://tallythemes.com/doc-item/dog-care-wordpress-theme-documentation/'));
	define('TALLY_THEME_SUPPORT_URL', esc_url('http://tallythemes.com/support/forum/wordpress-themes-support/dog-care-wordpress-theme-support/'));
