...
function tally_child_load_before_parant_theme(){
	...
	define('TALLY_THEME_DEMO_URL', esc_url('http://tallythemes.com/preview/handyman-wordpress-theme-preview/'));
	define('TALLY_THEME_DOC_URL', esc_url('http://tallythemes.com/doc-item/handyman-wordpress-theme-documentation/'));
	define('TALLY_THEME_SUPPORT_URL', esc_url('http://tallythemes.com/support/forum/wordpress-themes-support/handyman-wordpress-theme-support/'));
