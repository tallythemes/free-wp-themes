...
function tally_child_load_before_parant_theme(){
	...
	define('TALLY_THEME_STORE_URL', esc_url('http://tallythemes.com/product/bookkeeping-wordpress-theme/'));
	define('TALLY_THEME_DEMO_URL', esc_url('http://tallythemes.com/preview/bookkeeping-wordpress-theme-preview/'));
	define('TALLY_THEME_DOC_URL', esc_url('http://tallythemes.com/doc-item/bookkeeping-wordpress-theme-documentation/'));
	define('TALLY_THEME_SUPPORT_URL', esc_url('http://tallythemes.com/support/forum/wordpress-themes-support/bookkeeping-wordpress-theme-support/'));
