...
-------------------------------------------------------*/
add_filter( 'tally6a81f3a6cc23c9ea77639e7be6525ac0', '__return_true' );

add_filter( 'tallykit_FrontPagef5978c8e8ef32b19091ddfee02e45b06', '__return_true');
add_filter( 'tallykit_buddypress4342f29190297f46458e5ed63c44f80b', '__return_true');
add_filter( 'tallykit_gallery2befd93b7890eca147461b95745bba46', '__return_true');
add_filter( 'tallykit_logo510e07e0e618cbf112705b7392ffebcc', '__return_true');
add_filter( 'tallykit_people188f75b45dddd6e6ad1d22486fa65b55', '__return_true');
add_filter( 'tallykit_portfolio6414207aae08db5db313a8d7ac23f003', '__return_true');
add_filter( 'tallykit_shortcodes034acc1070e70b509127233fcd7c6fd0', '__return_true');
add_filter( 'tallykit_slideshow736927fc2af9ff07702941de416cc2bc', '__return_true');
add_filter( 'tallykit_testimonial3f2227e1daec3e9229b0b33e52c9179b', '__return_true');
