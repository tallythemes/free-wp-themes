...
function tally_child_load_before_parant_theme(){
	...
	define('TALLY_THEME_STORE_URL', 'http://tallythemes.com/product/hair-salon-wordpress-theme/');
	define('TK_THEME_NAME', 'Hair Salon');
	define('TALLY_THEME_NAME', 'Hair Salon');
	define('TALLY_THEME_DEMO_URL', esc_url('http://tallythemes.com/preview/hair-salon-wordpress-theme-preview/'));
	define('TALLY_THEME_DOC_URL', esc_url('http://tallythemes.com/doc-item/hair-salon-wordpress-theme-documentation/'));
	define('TALLY_THEME_SUPPORT_URL', esc_url('http://tallythemes.com/support/forum/wordpress-themes-support/hair-salon-wordpress-theme-support/'));
