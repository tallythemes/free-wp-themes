...
function tally_child_load_before_parant_theme(){
	...
	define('TALLY_THEME_STORE_URL', 'http://tallythemes.com/product/lawyers-wordpress-theme/');
	define('TK_THEME_NAME', 'Lawyers');
	define('TALLY_THEME_NAME', 'Lawyers');
	define('TALLY_THEME_DEMO_URL', esc_url('http://tallythemes.com/preview/lawyers-wordpress-theme-preview/'));
	define('TALLY_THEME_DOC_URL', esc_url('http://tallythemes.com/doc-item/lawyers-wordpress-theme-documentation/'));
	define('TALLY_THEME_SUPPORT_URL', esc_url('http://tallythemes.com/support/forum/wordpress-themes-support/lawyers-wordpress-theme-support/'));
