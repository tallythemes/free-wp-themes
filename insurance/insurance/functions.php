...
function tally_child_load_before_parant_theme(){
	...
	define('TALLY_THEME_DEMO_URL', esc_url('http://tallythemes.com/preview/insurance-wordpress-theme-preview/'));
	define('TALLY_THEME_DOC_URL', esc_url('http://tallythemes.com/doc-item/insurance-wordpress-theme-documentation/'));
	define('TALLY_THEME_SUPPORT_URL', esc_url('http://tallythemes.com/support/forum/wordpress-themes-support/insurance-wordpress-theme-support/'));
